...
var specs = []spec{
	...
	{Tool: Tool{ID: "omp", Name: "Oh My Pi", Category: "Agent CLIs", Command: "omp", Agent: true, Description: "Coding-first, provider-flexible agent CLI", AuthHints: []string{"Launch and use /login", "Config is stored below ~/.omp"}, Docs: "https://omp.sh/"}, VersionArgs: []string{"--version"}},
